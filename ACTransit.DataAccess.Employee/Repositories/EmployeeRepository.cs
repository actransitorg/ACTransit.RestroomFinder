...
namespace ACTransit.DataAccess.Employee.Repositories
{
    public class EmployeeRepository:BaseRepository
    {
        ...
        public async Task<EM.Employee> GetEmployeeByBadgeAsync(string badge)
        {
            return await ((EmployeeEntities)Context).Employees.FirstOrDefaultAsync(m => m.Badge != null && m.Badge == badge);
        }
        /// <summary>
        ...
        public string GetOrgChartJson(bool deptOnly, bool hasAccess)
        {
            return ((EmployeeEntities)Context).GetOrgChart(null, deptOnly, hasAccess, true).FirstOrDefault();
        }
    }
}
