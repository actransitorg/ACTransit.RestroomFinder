...
namespace ACTransit.Framework.DataAccess
{
        ...
        where TContext : DbContext, new()
    {
        ...
        public void SetCommandTimeout(int? timeoutValue)
        {
            if (_context != null)
                _context.Database.CommandTimeout = timeoutValue;
        }

        public int? GetCommandTimeout()
        {
            return _context?.Database?.CommandTimeout;
        }
        ...
        public virtual Task<T> GetByIdAsync<T, TId>(TId id) where T : class, new()
        {
