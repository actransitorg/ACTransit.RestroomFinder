...
namespace ACTransit.RestroomFinder.Web.Controllers
{
    public class RestroomReportController : Controller
    {
        ...
        // GET: RestroomReport
        public ActionResult Index(RestroomEnums.RestroomReportType reportType)
        {
            switch (reportType)
            {
                case RestroomEnums.RestroomReportType.Restrooms:
                    ViewBag.Title = "Restroom List Report";
                    ViewBag.ReportLocation = _restroomListReportLocation;
                    break;
                case RestroomEnums.RestroomReportType.Feedback:
