 ...
 */
public abstract class BaseFusionMapActivity extends BaseActivity implements OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener, IMapCallBack,ResultCallback<LocationSettingsResult> {
    ...
    private void setMap(){
        if (checkPermission()) {
            ...
            if (bar==null){
                android.support.v7.app.ActionBar bar1= getSupportActionBar();
                if (bar1!=null)
