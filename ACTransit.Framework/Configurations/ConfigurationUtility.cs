...
namespace ACTransit.Framework.Configurations
{
    public static class ConfigurationUtility
    {
        ...
        public static IDictionary<string, TValue> GetSectionAsDictionary<TValue>(string settingname)
        {
            var value = ConfigurationManager.GetSection(settingname) as NameValueCollection;
            return value?.ToDictionary<TValue>()?? new Dictionary<string, TValue>();
        }
