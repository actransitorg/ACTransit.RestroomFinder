...
//        if key.isEmpty {
//            throw CustomErrors.parameterError("parameter Key can't be null.")
//        }
    }
    ...
    public required convenience init?(coder aDecoder: NSCoder) {
        ...
        let value : String? = aDecoder.decodeObject(forKey: Keys.value) as? String
       
        let updateDateStr = aDecoder.decodeObject(forKey: Keys.updateDate) as? String ?? DateTime.min().toString()
