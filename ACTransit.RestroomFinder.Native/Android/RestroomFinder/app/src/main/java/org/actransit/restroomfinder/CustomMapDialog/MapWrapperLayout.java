...
public class MapWrapperLayout extends RelativeLayout {
    ...
    private TextViewIcon tviIsHistory;
    private TextViewIcon tviIsToiletAvailable;
    ...
    public void init(GoogleMap map, int bottomOffsetPixels, final View infoWindow, final IMapCallBack callBack) {
        ...
        this.tviIsHistory = (TextViewIcon) infoWindow.findViewById(R.id.tviIsHistory);
        this.tviIsToiletAvailable = (TextViewIcon) infoWindow.findViewById(R.id.tvisToiletAvailable);
        ...
        map.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
            ...
            public View getInfoContents(Marker marker) {
                ...
                if (model!=null){
                    ...
                    if ((Common.isWeekday() && model.weekdayHours !=null && !model.weekdayHours.equals("")) ||
                            (Common.isSaturday() && model.saturdayHours !=null && !model.saturdayHours.equals("")) ||
                            (Common.isSunday() && model.sundayHours !=null && !model.sundayHours.equals("")))
                        paddleHoursVisibility = VISIBLE;
                }
                imgWater.setVisibility(waterVisibility);
                tviIsHistory.setVisibility(model.isHistory ? View.VISIBLE : View.INVISIBLE);
                tviIsToiletAvailable.setVisibility(model.isToiletAvailable ? View.VISIBLE : View.INVISIBLE);
