...
namespace ACTransit.DataAccess.RestroomFinder
{
    ...
    public partial class Restroom
    {
        ...
        public Restroom()
        {
            RestroomStatusList = new HashSet<RestroomStatusList>();
        ...
        //[Required]  // We need to remove the required attribute as it is having issue with edit. When we try to save changes, out code will make this isModified=galse as well as sets its content to empty which triggers validation error.
        [StringLength(50)]
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<RestroomStatusList> RestroomStatusList { get; set; }
    }
}
